...
const socketChatApp = {
  namePage: 'socket-chat-app',
  img: '../photo-projects/chat-app.png',
  title: 'Socket-Chat-App',
  source: true,
  sourceCode: 'https://github.com/Sakoutecher/socket-chat-app',
  techno: [
    {
      alt: 'react',
      src: '../techno-icons/react.png'
    ...
    {
      alt: 'css',
      src: '../techno-icons/css3.png'
    },

    {
      alt: 'express',
      src: '../techno-icons/express.png'
    }
  ],
  descriptionEn: `Simple chat application between two users that displays messages in real time, for this project I used React, Javascript, Express.js and Socket.io.`,
  descriptionFr: `Simple application de chat entre deux utilisateurs qui affiche les messages en temps réels, pour ce projet j'ai utilisé React, Javascript, Express.js et Socket.io.`
}
