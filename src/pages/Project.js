        ...
        <CenterCenter>
          ...
          <Bottom>
            <ProjectDiv
              ...
              bg={
                theme === 'light'
                  ? './photo-projects/portfolio-night.png'
                  : './photo-projects/portfolio-light.png'
              }
              page={'portfolio'}
              language={language}
            />
            ...
            <ProjectDiv
              styles={styles}
              colors={colors}
              projects={AngularBookshelf}
              title={'App-Bookshelf'}
              bg={'./photo-projects/bookshelf-angular.png'}
              page={'angular-bookshelf'}
              language={language}
            />
            <ProjectDiv
              styles={styles}
              colors={colors}
              projects={SocketChatApp}
              title={'Socket-Chat-App'}
              bg={'./photo-projects/chat-app.png'}
              page={'socket-chat-app'}
              language={language}
            />
          </Bottom>
        </CenterCenter>
